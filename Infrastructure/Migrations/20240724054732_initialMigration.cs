        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdMenuPrimary = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "NormalizeProjectNames",
                schema: "Scaffolding",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameTMetric = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameNetSuite = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NormalizeProjectNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolMenusEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RolMenusEntity_Menu_IdMenu",
                        column: x => x.IdMenu,
                        principalSchema: "Security",
                        principalTable: "Menu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolMenusEntity_Rol_IdRol",
                        column: x => x.IdRol,
                        principalSchema: "Security",
                        principalTable: "Rol",
                        principalColumn: "IdRol",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerefiedEmail = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolMenusEntity_IdMenu",
                table: "RolMenusEntity",
                column: "IdMenu");

            migrationBuilder.CreateIndex(
                name: "IX_RolMenusEntity_IdRol",
                table: "RolMenusEntity",
                column: "IdRol");
